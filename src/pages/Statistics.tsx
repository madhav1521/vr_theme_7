...
function checkprop() {
  return <img src={checked_box} alt=""></img>;
}
function uncheckprop() {
  return <img src={unchecked_box} alt=""></img>;
}
...
export default function Statistics() {
  ...
  return (
    <>
      {/* <Helmet> <title>Statistics | company</title></Helmet> */}
            ...
            <Box className="page-content">
              ...
              <Box className="main-inner-card">
                  ...
                  <FormControl className="radio-check">
                    ...
                    >
                      <FormControlLabel
                        ...
                        control={
                          <Radio
                            icon={<Icon>{<img src={radio_unchecked} />}</Icon>}
                            checkedIcon={
                              <Icon>{<img src={radio_checked} />}</Icon>
                            }
                          />
                        }
                        label="Selected"
                ...
                <Typography
                  component="h6"
                  variant="h6"
                  className="inner-subhead snackbar-head page-subhead"
                  marginTop="31px"
                >
                  Snack Bar
                </Typography>
                <Grid container rowSpacing={3} columnSpacing={4}>
                      ...
                      <Collapse in={open1}>
                        ...
                        >
                          ...
                          <Typography
                            component="p"
                            variant="subtitle2"
                            className="text-message error-ic"
                          >
                  ...
                  <Grid item xs={12} md={6} id="alert-b" onClick={snackbarb}>
                    <Box className="validation-notes">
                      <Collapse in={open2}>
                        <Alert
                          className="text-info"
                        ...
                        >
                          ...
                          <Typography
                            component="p"
                            variant="subtitle2"
                            className="text-message info-ic"
                          >
                  ...
                  <Grid item xs={12} md={6} id="alert-c" onClick={snackbarc}>
                    <Box className="validation-notes">
                      <Collapse in={open3}>
                        <Alert
                          className="text-warn"
                        ...
                        >
                          ...
                          <Typography
                            component="p"
                            variant="subtitle2"
                            className="text-message warn-ic"
                          >
                  ...
                  <Grid item xs={12} md={6} id="alert-d" onClick={snackbard}>
                    <Box className="validation-notes">
                      <Collapse in={open4}>
                        <Alert
                        ...
                        >
                          ...
                          <Typography
                            component="p"
                            variant="subtitle2"
                            className="text-message valid-ic"
                          >
                ...
                <Typography
                  component="h6"
                  variant="h6"
                  className="inner-subhead cta page-subhead"
                >
                  CTA
                </Typography>
                ...
                <Box textAlign={"justify"}>
                  <TabPanel value={value} index={0}>
                    <Typography
                      ...
                      className="tab-text"
                    >
                      1,It is a long established fact that a reader will be
                  ...
                  <TabPanel value={value} index={1}>
                    <Typography
                      ...
                      className="tab-text"
                    >
                      2,It is a long established fact that a reader will be
                      distracted by the readable content of a page when looking
                      at its layout. The point of using Lorem Ipsum is that it
                      has a more-or-less normal distribution of letters, as
                      opposed to using 'Content here, content here', making it
                  ...
                  <TabPanel value={value} index={3}>
                    <Typography
                      ...
                      className="tab-text"
                    >
                      4,It is a long established fact that a reader will be
                      distracted by the readable content of a page when looking
                      at its layout. The point of using Lorem Ipsum is that it
                      has a more-or-less normal distribution of letters, as
                      opposed to using 'Content here, content here', making it
